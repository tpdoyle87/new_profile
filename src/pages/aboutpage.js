      ...
      <div className="content">
        <div className="first-section">
          ...
          <div className="content-container">
            ...
            />
            <Section
              text="The transition has not been without obstacles. I have spent almost everyday off I have had over the past few years learning something new, building some new small feature, and reading blogs related to software development. I focus mainly on rails applications but recently I have expanded to React apps as well."
            />
            <Section
